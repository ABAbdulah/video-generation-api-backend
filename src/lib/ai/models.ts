...
export const AI_MODELS: AiModel[] = [
  {
    ...
    label: "Mini",
    tier: "mini",
    description: "Instant, from the template library",
    // Costs a credit like everything else. At 0 the free tier was unlimited,
    // which left no reason to ever pay — the credit balance IS the free-tier
    // limit, so every generation has to move it.
    creditCost: 1,
  ...
  },
  {
    ...
    label: "Starter",
    tier: "starter",
    description: "AI-written, fast & affordable",
    creditCost: 2,
    requiredSubscriptionTier: "free",
